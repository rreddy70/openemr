...
<div class="rule_detail">
    ...
    <div class="section text">
        <p class="header"><?php out('Demographics filter criteria'); ?> <a href="index.php?action=edit!add_criteria&id=<?php echo $rule->id ?>&criteriaType=filter" class="action_link">(add)</a></p>
        <p>
                ...
                <?php foreach($filters->criteria as $criteria) { ?>
                    <div>
                        <span class="left_col">
                            ...
                            <a href="index.php?action=edit!delete_filter&id=<?php echo $rule->id ?>&guid=<?php echo $criteria->guid ?>" class="action_link">(delete)</a></span>
    ...
    <div class="section text">
        <p class="header"><?php out('Clinical targets'); ?> <a href="index.php?action=edit!add_criteria&id=<?php echo $rule->id ?>&criteriaType=target" class="action_link">(add)</a></p>
        <p>
                ...
                <?php foreach($targets->criteria as $criteria) { ?>
                    <div>
                        <span class="left_col">
                            ...
                            <a href="index.php?action=edit!delete_target&id=<?php echo $rule->id ?>&guid=<?php echo $criteria->guid ?>" class="action_link">(delete)</a></span>
                        </span>
                        <span class="mid_col"><?php echo( $criteria->getTitle() ) ?></span>
                        <span class="mid_col"><?php echo( $criteria->getCharacteristics() ) ?></span>
                        <span class="end_col">
    ...
    <div class="section text">
        <p class="header"><?php out('Actions'); ?> <a href="index.php?action=edit!add_action&id=<?php echo $rule->id ?>" class="action_link">(add)</a></p>
        <p>
            <?php if ( $actions->actions) { ?>
                ...
                <?php foreach($actions->actions as $action) { ?>
                    <span class="left_col">
                        <a href="index.php?action=edit!action&id=<?php echo $rule->id ?>&guid=<?php echo $action->guid ?>" class="action_link">(<?php out('edit') ?>)</a>
                        <a href="index.php?action=edit!delete_action&id=<?php echo $rule->id ?>&guid=<?php echo $action->guid ?>" class="action_link">(delete)</a></span>
